  ...
  return (
    <TouchableWithoutFeedback onPress={() => { dismissSearch(); Keyboard.dismiss(); }}>
      <View style={styles.container}>
        ...
        >
            <View style={{ position: 'relative' }}>
                <Image source={profileData?.logo_url ? { uri: getFullImageUrl(profileData.logo_url) || undefined } : require('../../assets/images/react-logo.png')} style={styles.headerLogo} resizeMode="contain" />
            </View>
        </TouchableOpacity>
