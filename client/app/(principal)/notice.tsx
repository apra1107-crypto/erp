...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, ActivityIndicator, StatusBar, Modal, TextInput, FlatList, Dimensions, Platform, RefreshControl, Image } from 'react-native';
