...
export default function TeacherIDCardSections() {
    ...
    const renderSectionCard = ({ item, index }: { item: any, index: number }) => (
        <Animated.View entering={FadeInUp.delay(index * 100)}>
            <TouchableOpacity 
                ...
                onPress={() => router.push({
                    pathname: `/(teacher)/id-card/[classSection]`,
            ...
            >
                ...
                <View style={styles.cardContent}>
                    ...
                    <Text style={[styles.sectionSub, { color: theme.textLight }]}>Download Digital IDs</Text>
                </View>
