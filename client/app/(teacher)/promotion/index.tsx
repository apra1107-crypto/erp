        ...
        <View style={styles.container}>
            ...
            <View style={styles.filterBar}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{marginBottom: 10}}>
                    {classes.map(cls => (
                        <TouchableOpacity key={cls} style={[styles.filterChip, filterClass === cls && {backgroundColor: theme.primary, borderColor: theme.primary}]} onPress={() => handleClassFilter(cls)}>
                ...
                {filterClass !== '' && (
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {sections.map(sec => (
                            <TouchableOpacity key={sec} style={[styles.filterChip, filterSection === sec && {backgroundColor: theme.primary, borderColor: theme.primary}]} onPress={() => handleSectionFilter(sec)}>
            ...
            >
                {filteredStudents.length === 0 ? (
                    <View style={{alignItems:'center', marginTop: 50}}>
                        ...
                        <Text style={{marginTop: 15, color: theme.textLight, fontWeight: '600'}}>No students found</Text>
                    </View>
                ) : (
